...
// Data
static GLWindowH*   g_Window = nullptr;
...
bool ImGui_ImplGL3_Init(GLWindowH* window)
{
	g_Window = window;
...
void ImGui_ImplGL3_NewFrame()
{
	...
	// Setup time step
	double current_time = STime::GetCurTime();
	io.DeltaTime = g_Time > 0.0 ? (float)(current_time - g_Time) : (float)(1.0f / 60.0f);
	printf("Deltatime: %f", io.DeltaTime);
	g_Time = current_time;
...
IMGUI_API LRESULT ImGui_ImplGL3_WndProcHandler(HWND, UINT msg, WPARAM wParam, LPARAM lParam)
{
	ImGuiIO& io = ImGui::GetIO();
	switch (msg)
	{
